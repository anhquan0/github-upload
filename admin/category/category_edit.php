...
<div class="modal fade" id="<?php echo $ID.'modaledit' ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<form action="category_edit_process.php?ID=<?php echo $ID ?>" method="post">
			<div class="modal-body">
				<div class="form-group">
				    <label for="name<?php echo $ID ?>"> Name </label>
				    <input type="text" name="name" class="form-control" id="name<?php echo $ID?>" placeholder="Enter category name" value="<?php echo $name ?>">
				  </div>
			</div>
